                  ...
                  {dropdownOpen && (
                    ...
                    >
                      ...
                      <div className="px-3 pt-2 pb-2 space-y-0.5">
                        ...
                        {/* ── Identity & Membership ───────────────────────────
                            Anchor items — who I am + my door pass. */}
                        ...
                        {/* ── High-frequency surfaces ─────────────────────────
                            Messages bubbled up from position 6 — it's the most-
                            opened item in a social app and was buried before.
                            Notifications + My Hangouts were orphans only
                            reachable via the bell icon or a push notification. */}
                        ...
                        <Link href="/notifications" onClick={() => setDropdownOpen(false)} className="flex items-center gap-2 px-2 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                        ...
                        <Link href="/hangouts/recap" onClick={() => setDropdownOpen(false)} className="flex items-center gap-2 px-2 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                        ...
                        {/* ── Social / location ───────────────────────────────
                            "Connections" replaces "Contacts" to match the
                            MemberConnection model and the language used
                            elsewhere in the app. Profile Visitors moved down —
                            it's a vanity surface, not a daily destination. */}
                        ...
                        {/* ── Perks / config / growth ─────────────────────────
                            Perks was orphaned — only reachable by typing the
                            URL. Settings + Invite stay together as the
                            "manage / spread the word" cluster. */}
                        <Link href="/perks" onClick={() => setDropdownOpen(false)} className="flex items-center gap-2 px-2 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
