...
export default function SocialShare({ title, url, cacheKey }: Props) {
  ...
  const btnCls = 'flex-1 flex items-center justify-center py-2.5 rounded-xl text-white transition-colors'
    ...
    <div className="bg-white rounded-2xl shadow-card p-5">
      ...
      <div className="flex gap-2">
        ...
        <button onClick={copyLink} title="Copy link"
          className="flex-1 flex items-center justify-center py-2.5 rounded-xl bg-gray-100 hover:bg-gray-200 text-gray-600 transition-colors">
          {copied ? (
