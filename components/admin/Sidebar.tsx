...
const ICONS: Record<string, JSX.Element> = {
  cities:       <Icon d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />,
  ...
  noshows:      <Icon d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9" />,
  ...
  jobs:         <Icon d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />,
  ...
  // Coffee cup — spontaneous member meetups (the feed already uses ☕).
  hangouts:     <Icon d="M3 8h11v5a4 4 0 01-4 4H7a4 4 0 01-4-4V8zm11 1h2.5a2.5 2.5 0 010 5H14" d2="M6 2v2M9.5 2v2" />,
...
export const ICON_PATHS: Record<string, { d: string; d2?: string }> = {
  ...
  noshows:      { d: 'M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9' },
  ...
  jobs:         { d: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  hangouts:     { d: 'M3 8h11v5a4 4 0 01-4 4H7a4 4 0 01-4-4V8zm11 1h2.5a2.5 2.5 0 010 5H14', d2: 'M6 2v2M9.5 2v2' },
