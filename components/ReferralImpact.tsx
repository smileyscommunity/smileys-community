    ...
    <div className="bg-white rounded-2xl shadow-card p-5 overflow-hidden relative group">
      ...
      <div className="grid grid-cols-2 gap-4 relative z-10">
        <div>
          ...
          <p className="text-xs font-bold text-gray-500 uppercase tracking-wider mt-1">Friends joined</p>
        </div>
        <div className="border-l border-gray-100 pl-4">
          <p className="text-2xl font-black text-violet-500 leading-none">{eventCount}</p>
          <p className="text-xs font-bold text-gray-500 uppercase tracking-wider mt-1">Events attended</p>
        </div>
      </div>
