    ...
    return (
      <div className="bg-white rounded-2xl shadow-card p-6">
        ...
        <button
          onClick={leave}
          disabled={loading}
          className="w-full py-2.5 rounded-xl border border-gray-200 text-sm font-semibold text-gray-600 hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition-colors disabled:opacity-40"
        >
