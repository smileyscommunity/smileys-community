...
// banner + community polls). Moved here so the sidebar grouping reads true.
// The /admin/engagement route still works as a redirect to keep bookmarks.
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-zinc-500 mt-0.5">
          {tab === 'polls'
            ...
            : 'Top-of-page banner shown to every logged-in member.'}
        </p>
      </div>

      {/* Tab nav so admins can flip between the two surfaces without leaving */}
