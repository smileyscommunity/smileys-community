  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 max-w-4xl">
      ...
      {/* Donations queue — submissions from the public /cup
          ...
          day or two). Approve/decline routes the row; admin then
          creates the matching Sponsor + Prize via /api/admin/cup/
          sponsors and /api/admin/cup/prizes. */}
      <DonationsQueue />
...
// rows first; approved/declined collapsed below. Each row gets
// approve/decline buttons; on approve, admin still needs to
// create the Sponsor + Prize via the dedicated routes (we don't
// auto-create so admin keeps full control over copy + ranking).
// ─────────────────────────────────────────────────────────────────
interface Donation {
  id: string
