    ...
    <div className="min-h-screen bg-warm pb-24 md:pb-0">
      ...
      <div className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
          <Link href="/listings" className="p-1.5 rounded-lg text-gray-500 hover:bg-gray-100 transition-colors">
          ...
          <div className="p-6 space-y-5">
            ...
            {session ? (
              ...
              <div className="text-center space-y-3 py-4 bg-amber-50 rounded-2xl px-4">
                ...
                <p className="text-xs text-gray-500">Sign in to contact this member and see full details.</p>
                <Link href="/login"
