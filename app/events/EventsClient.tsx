...
function AppEventsPageInner() {
  ...
  // ?city=<slug>: the /events server page pins the city in the URL so the
  // address bar is a shareable link (lib/cityPageParam). It has to reach the
  // calendar fetch and survive the URL sync, or the list would follow the
  // cookie while the page's metadata names the pinned city.
