  ...
  return (
    <>
      ...
      {/* Stories — the homepage's card treatment, not a text strip: on the
          ...
          Ahead of the pull-quotes below on purpose: a written piece with a
          photo carries further than a one-line quote, and a founding city
          usually has stories before it has quotes — so the section that can
          actually speak for it comes first. */}
      ...
      {/* Member quotes. No member-count gate here any more: the query itself
          is now the honest filter. A quote reaches this page only if it
          belongs to this city or was deliberately marked across-Smileys, so a
          brand-new city shows nothing until someone says something about it. */}
