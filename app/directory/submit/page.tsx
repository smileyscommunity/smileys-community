...
export default function SubmitBusinessPage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-6">
      <button onClick={() => router.back()} className="flex items-center gap-1.5 text-xs text-gray-500 mb-5 hover:text-gray-700">
      ...
      <p className="text-sm text-gray-500 mb-6">Know a great expat-owned or expat-friendly business? Add it to the community directory.</p>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <button type="button" onClick={() => set('isExpatOwned', !form.isExpatOwned)}
          ...
          <p className="text-[11px] text-gray-500 mt-0.5">Owned or co-owned by an expat</p>
        ...
        <button type="button" onClick={() => set('isExpatFriendly', !form.isExpatFriendly)}
          ...
          <p className="text-[11px] text-gray-500 mt-0.5">English-speaking or welcoming to expats</p>
