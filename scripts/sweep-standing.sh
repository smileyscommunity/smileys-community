#!/bin/bash
# Cron-driven sweeper that resolves attendance and keeps standing cards up to date (see
# app/api/cron/sweep-standing/route.ts). Runs hourly from system
