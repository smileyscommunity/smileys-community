#!/bin/bash
# Cron-driven sweeper for cup match-reminder pushes (see
# app/api/cron/sweep-cup-reminders/route.ts). Designed to run every 5
# minutes from system crontab on the prod box.
#
