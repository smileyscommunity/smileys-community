#!/bin/bash
# Cron-driven sweeper that settles attendance and issues no-show cards (see
# app/api/cron/sweep-no-shows/route.ts). Runs hourly from system
