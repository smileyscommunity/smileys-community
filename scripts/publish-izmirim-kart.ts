...
<p>Cards and tickets are sold at Konak and Karşıyaka ferry terminals, at the central metro stations — Konak, Fahrettin Altay, Bornova, Halkapınar and Şirinyer — at the airport stations, and at designated 24-hour booths around the city.</p>
<h2>Topping up</h2>
...
<p>On the metro, tram, İZBAN and the ferries, the second and any subsequent rides within 90 minutes of your first are <strong>free</strong>. A ferry across the bay followed by a metro ride is one fare, not two — so long as you tap within the window.</p>
